...
export class UserMongo {
  ...
  static createInstance(dto: CreateUserDomainDto): UserMongoDocument {
    const user = new this();
    ...
    return user as UserMongoDocument;
  }
...
export type UserMongoModelType = Model<UserMongoDocument> & typeof UserMongo;
